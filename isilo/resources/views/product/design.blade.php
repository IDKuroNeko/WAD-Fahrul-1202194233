...
<div class="container">
  <div class="card">
    ...
    <div class="row">
      <div class="col-md-6">
        <form action="{{ route('product.design.store') }}" method="post" enctype="multipart/form-data">  
          @csrf       
          ...
          <div class="form-outline mb-4">
            <input type="text" id="form6Example3" class="form-control" name="designer" required />
            <label class="form-label" for="form6Example3">Nama Designer</label>
          </div>
